...
Data di rilascio: 18 Ottobre, 2024
    ...
    * Correzione bug : Validazione buono con nuova chiamata check() 


= 1.4.4 =
Data di rilascio: 18 Ottobre, 2024

    * Implementazione: Nuovo metodo di chiamata check() 


= 1.4.3 =
Data di rilascio: 18 Ottobre, 2024

    * Implementazione: No cache WSDL 
...
Data di rilascio: 17 Ottobre, 2024
    ...
    * Update: Supporto WP 6.6
    * Update: Supporto WC 9 
