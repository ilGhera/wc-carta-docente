...
Data di rilascio: 24 Settembre, 2026
    ...
    * Compatibilità: WooCommerce 11.1.2
...
Data di rilascio: 4 Febbraio, 2026
    ...
    * Miglioramento: Aggiornato certificato demo
    * Update: Supporto WP 6.9

= 1.4.7 =
Data di rilascio: 22 Dicembre, 2025

    * Correzione bug: Caricamento file WSDL tramite filesystem invece di URL
    * Correzione bug: Gestione eccezioni SOAP con isset()
